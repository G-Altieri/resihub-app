...
export default function CalorePage() {
  ...
  // Filtra i dispositivi di tipo "Calore"
  const devices = parsedData.dispositivi.filter(
    (device: any) => device.tipo === 'Calore'
  );
  ...
  return (
    <View style={styles.container}>
      <Image
        source={require('../../../assets/images/SfondoCalore.jpg')}
        style={StyleSheet.absoluteFill}
        resizeMode="contain"
      />
      <Text style={styles.title}>Dispositivi di Calore</Text>
      <TextInput
